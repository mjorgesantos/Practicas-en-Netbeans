...
//        scrollPane1.setVisible(false);
        ...
        public void run() {
            try {
                while (true) {
                    ...
                    if (d > 0) {
                        String cadh = "";
                        cadh = Integer.toHexString(d);

                        System.out.println(cadh);
                        Object[] otraFilaDeLaTableh = {" \t" + ds + "..Es equivalente  \n" + "\t\t.." + cadh + "..en Hexadecimal"};//no borrar
                        // Object[] otraFilaDeLaTable = {"\t\t" + ds+ ""};
                        h.setText("Cargando en \t" + ds + "%..." + "\t Procesando \t" + cadh + "%...");
  ...
  NewThread() {
    hilo_1 = new Thread(this, "Demo Thread");
    System.out.println("otro proceso: " + hilo_1);
   hilo_1.start(); // Start the thread
  }
