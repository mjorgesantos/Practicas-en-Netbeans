...
public class TablaNumeros extends Thread implements ActionListener {
    ...
    private JButton interrumpe1 = new JButton("Interrumpir binarios");
    private JButton interrumpe2 = new JButton(" interrumpir nº primos");
    ...
    private JLabel accion = new JLabel("");
    private JLabel porcentaje = new JLabel("777777777777777777777777777777777");
    ...
    public TablaNumeros() {
        ...
        interrumpe1.setBounds(70, 120, 200, 40);
        interrumpe2.setBounds(290, 120, 200, 40);
        ...
        ventana.add(interrumpe1);
        ventana.add(interrumpe2);
